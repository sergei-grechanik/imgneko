...
echo '== missing option =='
# Exercise each required-option branch. The command validates required
# arguments with short-circuiting checks.
check_exit_code 2 "$IMGNEKO" placeholder --size 1x1
# CHECK:      {{^}}== missing option =={{$}}
# CHECK-NEXT: {{^}}error: missing required option: --id{{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1
# CHECK-NEXT: {{^}}error: missing required option: --size{{$}}

echo '== invalid placement id =='
check_exit_code 2 "$IMGNEKO" placeholder --id 1 --placement-id 0x1000000 --size 1x1
...
# command.
check_exit_code 2 "$IMGNEKO" placeholder --id= --size 1x1
...
check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --bg ""
...
check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --bg 256
...
check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --bg 1x
...
check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size ""
# CHECK-NEXT: {{^}}error: invalid value for --size: '' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1
# CHECK-NEXT: {{^}}error: invalid value for --size: '1' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1xx1
# CHECK-NEXT: {{^}}error: invalid value for --size: '1xx1' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size x
# CHECK-NEXT: {{^}}error: invalid value for --size: 'x' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x0
# CHECK-NEXT: {{^}}error: invalid value for --size: '1x0' (expected positive A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 0x1
# CHECK-NEXT: {{^}}error: invalid value for --size: '0x1' (expected positive A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 4294967296x1
# CHECK-NEXT: {{^}}error: invalid value for --size: '4294967296x1' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1xy
# CHECK-NEXT: {{^}}error: invalid value for --size: '1xy' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x-1
# CHECK-NEXT: {{^}}error: invalid value for --size: '1x-1' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x4294967296
# CHECK-NEXT: {{^}}error: invalid value for --size: '1x4294967296' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1@0,0
# CHECK-NEXT: {{^}}error: invalid value for --size: '1x1@0,0' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at ""
# CHECK-NEXT: {{^}}error: invalid value for --at: '' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at 1
# CHECK-NEXT: {{^}}error: invalid value for --at: '1' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at 1,2,3
# CHECK-NEXT: {{^}}error: invalid value for --at: '1,2,3' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at -1,0
# CHECK-NEXT: {{^}}error: invalid value for --at: '-1,0' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at 4294967296,0
# CHECK-NEXT: {{^}}error: invalid value for --at: '4294967296,0' (expected A,B or AxB with base-10 unsigned integers){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at 4294967295,0
# CHECK-NEXT: {{^}}error: failed to format --at prefix{{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at 0,4294967295
# CHECK-NEXT: {{^}}error: failed to format --at prefix{{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at-column x
# CHECK-NEXT: {{^}}error: invalid value for --at-column: 'x' (expected a base-10 unsigned integer){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at-column -1
# CHECK-NEXT: {{^}}error: invalid value for --at-column: '-1' (expected a base-10 unsigned integer){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at-column 4294967296
# CHECK-NEXT: {{^}}error: invalid value for --at-column: '4294967296' (expected a 32-bit unsigned integer){{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at-column 4294967295
# CHECK-NEXT: {{^}}error: failed to format --at-column prefix{{$}}

check_exit_code 2 "$IMGNEKO" placeholder --id 1 --size 1x1 --at 1,2 --at-column 3
...
(
    ...
    (
        ...
        "$IMGNEKO" placeholder --id 1 --size 1x1
