...
run_placeholder -p 3x3 -C bottom-right
# CHECK-NEXT: {{^}}[[ph(0, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
...
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(2, "0:2")]]{{END$}}
run_placeholder_fail -p 3x3 --cursor-movement text --at-cursor -C bottom-right
# CHECK-NEXT: {{^}}error: --cursor-movement text cannot be used with --at-cursor{{$}}
run_placeholder_fail -p 3x3 --cursor-movement text --at 4,3 -C bottom-right
# CHECK-NEXT: {{^}}error: --cursor-movement text requires --at X,Y with X equal to 0{{$}}
run_placeholder_fail -p 3x3 --cursor-movement text --at-column 3 -C bottom-right
# CHECK-NEXT: {{^}}error: --cursor-movement text requires --at-column 0{{$}}
run_placeholder -p 3x3 --cursor-movement text --at 0,3 -C bottom-right
# CHECK-NEXT: {{^\x1b\[4;1H}}[[ph(0, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(2, "0:2")]]{{END$}}
run_placeholder -p 3x3 --cursor-movement text --at-column 0 -C bottom-right
...
run_placeholder -p 3x3 --cursor-movement text -C next-line
# CHECK-NEXT: {{^}}[[ph(0, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(2, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}END{{$}}
run_placeholder -p 3x3 --cursor-movement text -C bottom-left
# CHECK-NEXT: {{^}}[[ph(0, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(2, "0:2")]]{{\x1b\[3DEND$}}
run_placeholder -p 3x3 --cursor-movement text -C below-left
# CHECK-NEXT: {{^}}[[ph(0, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
...
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(2, "0:2")]]{{END$}}
run_placeholder -p 3x3 --cursor-movement text -C top-left
# CHECK-NEXT: {{^}}[[ph(0, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(2, "0:2")]]{{\x1b\[3D\x1b\[2AEND$}}
run_placeholder -p 3x3 --cursor-movement text -C top-right
# CHECK-NEXT: {{^}}[[ph(0, "0:2")]]{{$}}
# CHECK-NEXT: {{^}}[[ph(1, "0:2")]]{{$}}
...
run_placeholder -p 3x1 --cursor-movement absolute -C top-left
# CHECK-NEXT: {{^\x1b\[1;1H}}[[ph(0, "0:2")]]{{\x1b\[1;1HEND$}}
run_placeholder -p 3x1 --cursor-movement absolute -C top-right
...
run_placeholder -p 1x1 --cursor-movement absolute -C next-line
# CHECK-NEXT: {{^\x1b\[1;1H}}[[ph(0, 0)]]{{\x1b\[2;1HEND$}}
run_placeholder -p 3x1 --cursor-movement move-left -C top-left
# CHECK-NEXT: {{^}}[[ph(0, "0:2")]]{{\x1b\[3DEND$}}
run_placeholder -p 3x1 --cursor-movement move-left -C top-right
