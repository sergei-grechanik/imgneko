...
# random data, including both compression and decompression.
...
case "$BENCHMARK_PRESET" in
    small)
        ...
        BENCHMARK_COMPRESS_BATCH_SIZE="${BENCHMARK_COMPRESS_BATCH_SIZE:-2}"
...
benchmark_zlib_data_set random "$BENCHMARK_COMPRESS_BATCH_SIZE" \
